const qnaList = [
  {
    ...
    a: [
      { answer: 'a. 햇볕 잘드는 창가', type: ['cow', 'tiger', 'dragon', 'chick'] },
      { answer: 'b. 가끔 은은하게 해드는 방구석', type: ['mouse', 'rabbit', 'horse', 'snake', 'dog', 'monkey'] },
  ...
  },
  {
    q: '2. 당신의 귀차니즘은? ',
    a: [
      { answer: 'a. 밥먹는것도 귀찮아.. 식물키우면 말려죽이고 말거야 ', type: ['mouse', 'rabbit', 'tiger', 'monkey'] },
      { answer: 'b. 귀찮지만.. 다들그러면서 사는거 아니겠어? 가끔은 신경써줄수 있어 ', type: ['cow', 'horse', 'snake', 'dog'] },
      { answer: 'c. 파워 부지런인간 관리는 맡겨둬!', type: ['sheep', 'dragon', 'chick', 'pig'] },
    ]
  },
  {
    q: '3. 식물 기르기 고수인가요? ',
    a: [
      { answer: 'a. 초보입니다', type: ['cow', 'rabbit', 'tiger', 'dog', 'monkey'] },
      { answer: 'b. 경험은 있습니다', type: ['sheep', 'chick', 'pig'] },
      { answer: 'c. 고수입니다. 까다로운 식물도 okay', type: ['mouse', 'horse', 'snake', 'dragon'] }
    ]
  },
  {
